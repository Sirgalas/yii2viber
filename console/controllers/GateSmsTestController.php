...
class GateSmsTestController extends Controller
{
    ...
    public function actionScenario()
    {
        ...
        $vm = ViberMessage::find()->where(['in', 'id', ['1']])->one();
    ...
    public function actionNotify(){
        $data='{"results": [{"messageId":"5aa724ec45625875152990d1","to":"79135701037","sentAt":"2018-03-13T04:13:18.308+0300","seenAt":"2018-03-13T04:13:19.058+0300"}]}';
