...
class StatisticsController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $clients = ArrayHelper::map(User::find()->select([
            'id',
            'username'
        ])->where(['dealer_id' => Yii::$app->user->identity->id])->orderBy('username')->asArray()->all(), 'id',
            'username');
        ...
        return $this->render('index',
            compact('model', 'contact_collections', 'searchModel', 'dataProvider', 'clients', 'post',
                'messagePhoneList', 'status', 'providerFromGetModel'));
    }
